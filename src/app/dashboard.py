...
#show employees
    ...
    try:
        ...
        if employees:
            ...
            selected_id = st.selectbox("Select Employee", employee_ids)
            ...
            with st.form("edit_employee_form"):
                ...
                with col1:
                    first_name = st.text_input(
                        "First Name", value=selected_employee.first_name
                    )

                    last_name = st.text_input(
                        "Last Name", value=selected_employee.last_name
                    )

                    email = st.text_input("Email", value=selected_employee.email)

                    phone = st.text_input("Phone", value=selected_employee.phone or "")
                ...
                with col2:
                    designation = st.text_input(
                        "Designation", value=selected_employee.designation
                    )
                    ...
                    branch = st.selectbox(
                        "Branch",
                        branch_options,
                        index=branch_options.index(selected_employee.branch),
                    )

                    joining_date = st.date_input(
                        "Joining Date", value=selected_employee.joining_date
                    )

                    status = st.selectbox(
                        "Status",
                        ["Active", "Inactive"],
                        index=["Active", "Inactive"].index(selected_employee.status),
                    )
